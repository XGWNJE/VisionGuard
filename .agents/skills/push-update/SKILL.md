...
# Android 检测端 — 复制并重命名
Copy-Item "detector/android/app/build/outputs/apk/release/app-release.apk" "$releases/VisionGuard-Detector-v<ver>.apk" -Force

# Android 接收端 — 复制并重命名
Copy-Item "receiver/android/app/build/outputs/apk/release/app-release.apk" "$releases/VisionGuard-Receiver-v<ver>.apk" -Force
```
