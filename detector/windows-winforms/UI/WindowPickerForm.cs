...
namespace VisionGuard.UI
{
    internal class WindowPickerForm : Form
    {
        ...
        private void BuildUI()
        {
            ...
            _btnRefresh = new Button { Text = "刷新", Width = 90, Height = 30 };
            _btnOk      = new Button { Text = "确定", Width = 90, Height = 30 };
            _btnCancel  = new Button { Text = "取消", Width = 90, Height = 30 };
        ...
        private void LoadWindowsAsync()
        {
            ...
            ThreadPool.QueueUserWorkItem(_ =>
            {
                ...
                try { list = WindowEnumerator.GetWindows(_excludeHwnd); }
                catch { list = new List<WindowInfo>(); }
