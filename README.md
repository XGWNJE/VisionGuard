...
[![Version](https://img.shields.io/badge/version-4.4.1-1f6feb)](./VERSION)
...
以下 GIF 由 `v4.4.0` 的本地 Release 客户端在离线环境录制，展示四个客户端的真实运行界面与基础导航流程。
...
v4.4.1 发行包不包含 ONNX 模型，首次启动或切换模型时由客户端从 Server 下载并缓存。
